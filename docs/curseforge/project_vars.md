...
| `framework` | `neoforge` |
| `java_version` | `21` |
| `version` (`gradle.properties`) | `0.0.0-beta.3` |
...
Formato: `<mc-version>-<framework>-<version>`. Actual: `1.21.1-neoforge-beta.3` (ya creado y pusheado).
...
5. `./gradlew clean build` — **[hecho]**, jar `majestic-1.21.1-neoforge-21.1.249-0.0.0-beta.3.jar`.
6. `docs/curseforge/versions/0.0.0-beta.3.md` (HTML) — release notes de la versión ya taggeada.
