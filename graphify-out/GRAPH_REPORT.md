...
## Corpus Check
- 191 files · ~60,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 993 nodes · 1670 edges · 89 communities (60 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a6d64a0b`
...
7. `[0.0.0-beta.17]` - 17 edges
8. `MajesticEntities` - 15 edges
...
Cohesion: 0.05
Nodes (43): [0.0.0-beta.1], [0.0.0-beta.17], [0.0.0-beta.2], [0.0.0-beta.3], [0.0.0-beta.4], [0.0.0-beta.5], [0.0.0-beta.6], [0.0.0-beta.7] (+35 more)
...
Cohesion: 0.09
Nodes (21): GeoEntity, FallenWatcherModel, DelayedMeleeAttack, LivingEntity, Nullable, FallenWatcher, AnimatableInstanceCache, AnimationState (+13 more)
...
Cohesion: 0.12
Nodes (16): Spider, MeteorCrawlerModel, AnimatableInstanceCache, AnimationState, BlockPos, BlockState, ControllerRegistrar, DamageSource (+8 more)
...
## Knowledge Gaps
- **208 isolated node(s):** `Workflow del mod`, `Recordatorios específicos`, `Prioridad de instrucciones`, `Changed`, `Added` (+203 more)
...
- **Why does `WardenOfTheGate` connect `WardenOfTheGateModel` to `WardenOfTheGateRenderer`, `Majestic — GeckoLib model guide: Astral Construct (Boss I minion)`, `WardenAttackGoal`, `.tickCharge`, `.sweepImpact`, `WardenOfTheGateModel`, `Starlight Ward`, `CompoundTag`, `Event Handling`, `.applyScaling`, `CompoundTag`, `Majestic — Guía de modelo GeckoLib: Jefe I (Warden of the Gate)`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `AstralConstruct` connect `Astral Altar Entity` to `Majestic — Guía de modelo GeckoLib: Jefe I (Warden of the Gate)`, `FallenWatcher`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `FallenWatcher` connect `FallenWatcher` to `Majestic — Guía de modelo GeckoLib: Jefe I (Warden of the Gate)`?**
